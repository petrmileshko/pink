...
const scriptsjs = () => {
  return gulp.src("source/js/app.js")
    .pipe(terser()) // обработчик файла Js скриптов
...
const copy = (done) => {
  return gulp.src([
      ...
      "source/js/lib/*.js" // копируем готовые сценарии интерфесов из библиотеки
      //"source/outlines.css"  копируем стили для визуального выделения блоков, убрать когда проект закончен
    ], {
      base: "source"
    })
